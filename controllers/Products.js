...
async function remove(req, res) {
    ...
    Product.remove({
        ...
        if(err)  return res.json({err: errorMsg("Error removing Product! Try again!")})
...
function getOne(req, res) {
    ...
    Product.findOne({        
        ...
        if(err) return res.json({err: errorMsg("Error fetching Product")})
...
function update(req, res) {
    ...
    Product.updateOne({
        ...
        if(err) return res.json({err: errorMsg("Error updating Product")})
